...
import { Loader2, Package, Boxes, Server, Cloud, ShieldCheck, ShieldAlert, DollarSign, TrendingUp, AlertCircle, CheckCircle2, Users, KeyRound, Percent } from "lucide-react";
...
export function Client360Subscriptions({ clientId, token }) {
  ...
  return (
    <div className="space-y-4" data-testid="client360-subscriptions">
      ...
      <div className="text-[10px] uppercase tracking-widest text-zinc-500 mt-4">Sources</div>
      ...
      <p className="text-[11px] text-zinc-500">Combines Pax8 CSP subscriptions, Acronis backup usage, and active recurring invoices. Monthly totals used in cash-flow forecast.</p>
    </div>
  );
}
...
export function Client360Security({ clientId, token }) {
  ...
  return (
    <div className="space-y-4" data-testid="client360-security">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
...
export function Client360Billing({ clientId, token }) {
  ...
  return (
    <div className="space-y-4" data-testid="client360-billing">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      ...
      {b.payment_promises && (b.payment_promises.kept + b.payment_promises.broken > 0) && (
        <div className="border border-zinc-800 rounded-md p-3 bg-zinc-950 text-xs flex items-center gap-3">
