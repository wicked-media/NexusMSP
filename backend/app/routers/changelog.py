...
CHANGELOG = [
    {
        ...
        "highlights": [
            ...
            "New hubs: Client Insights (/client-insights), Auto-Ops (/auto-ops), Team Hub (/team-hub)",
    ...
    {
        "id": "m365-evidence-first",
        "date": "2026-07-21",
        "title": "Microsoft 365 evidence-first workspace",
        "summary": "Mock Microsoft 365 tenants, posture metrics, alerts and remediation results have been retired. The workspace now shows provider-verified evidence only and separates planning references from live Microsoft actions.",
        "category": "security",
        "highlights": [
            "Connection readiness with explicit verification requirements",
            "Reference guardrails and Conditional Access templates that cannot masquerade as applied policies",
            "GDAP least-privilege templates plus provider-confirmed relationship evidence",
            "Auditable detection drafts that remain inactive until evaluated telemetry is connected",
        ],
        "links": [{"label": "Open Microsoft 365", "to": "/m365"}],
    },
    {
    ...
    },
    {
        ...
        "highlights": [
            ...
            "AI-generated summaries via Nexus AI for every run",
        ],
