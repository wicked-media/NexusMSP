...
SUPPORTED_PROVIDERS = [
    ...
    },
    {
        "id": "meshcentral",
        "name": "MeshCentral",
        "description": "Enterprise-grade open-source remote management. White-labelable, web-based, no client needed for basic access.",
        "type": "self-hosted",
        "license": "Free / Self-Hosted (Apache 2.0)",
        "features": ["Remote Desktop", "Remote Terminal", "File Transfer", "Intel AMT/IPMI", "Device Groups", "White-Label", "2FA", "Web-based (no client needed)", "Wake-on-LAN"],
        "config_fields": [
